...
# ============================================================
TOPIC_RULES = {
    10: {        # ðŸ† Bragging Rights
        "text": False,
        "photo": True,
        "video": True,
        "doc_ext": {".jpg", ".jpeg", ".png", ".mp4"}
    },
    8201: {      # ðŸŽ­ Mission Banners
        "text": False,
        "photo": True,
        "video": False,
...
# ============================================================
# 4ï¸âƒ£ DELETE HANDLER (TARGET GROUP)
# ============================================================
...
# =========================
client.start()
print("ðŸš€ Forwarding + topic moderation active (final)")
